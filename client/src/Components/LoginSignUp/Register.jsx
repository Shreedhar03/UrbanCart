        ...
        <>
            ...
            <section className="flex items-center justify-evenly flex-wrap h-screen w-screen bg-[var(--primary)]">
                ...
                <div className="flex flex-col items-center gap-8 bg-[var(--primary)] text-white rounded-lg w-[330px] sm:w-[400px] xl:w-[520px]">
                    ...
                    <form className='flex flex-col gap-6 w-[90%] xl:w-[65%] sm:w-[75%]' onSubmit={handleSubmit}>
                        ...
                        <input type="password" value={credentials.password} required placeholder='Password' autoComplete='off' onChange={(e) => { handleChange(e) }} name='password' className='focus:outline-none bg-[#143d5f] rounded-lg px-3 py-2' />
                        <input type="password" value={credentials.confirmPassword} required placeholder='Confirm Password' autoComplete='off' onChange={(e) => { handleChange(e) }} name='confirmPassword' className='focus:outline-none bg-[#143d5f] rounded-lg px-3 py-2' />
