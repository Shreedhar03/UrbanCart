    ...
    return (
        <>
            ...
            <section className="flex flex-row-reverse items-center justify-evenly flex-wrap my-8">
                ...
                <div className="container-main flex flex-col items-center gap-14 py-16 bg-slate-200 w-[500px] rounded-lg">
                    ...
                    <form action="" className='flex flex-col items-center gap-8'>
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" value={credentials.email} onChange={(e) => { handleChange(e.target.name, e.target.value) }} name='email' id='email' className='focus:outline-none rounded-lg bg-slate-100 px-3 py-2 text-xl' autoComplete='off' />
                        </div>
                        <div className="flex flex-col gap-2">
                            <label htmlFor='password' className='text-xl'>Password</label>
                            <input type="password" value={credentials.password} onChange={(e) => { handleChange(e.target.name, e.target.value) }} name='password' id='password' className='focus:outline-none rounded-lg bg-slate-100 px-3 py-2 text-xl' />
                        </div>
