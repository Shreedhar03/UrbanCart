    ...
    return (
        <>
            ...
            <section className="flex flex-row-reverse items-center justify-evenly flex-wrap h-screen">
                ...
                <div className="container-main flex flex-col items-center gap-10 py-16 bg-[#12283a] text-white w-[420px] rounded-lg">
                    ...
                    <h1 className="text-2xl text-center font-semibold text-[var(--primary)]">Log in To Your Account</h1>
