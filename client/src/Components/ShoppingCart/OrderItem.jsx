...
const OrderItem = (props) => {
  return (
    <div className='bg-gray-100 px-4 py-6 rounded-2xl mx-3'>
          ...
          return (
            <>
              <div key={key} className='flex justify-between sm:px-12'>
                ...
                <p className='text-xl font-semibold text-gray-900'>${(ele.product.price - ele.product.price * ele.product.discountPercentage / 100).toFixed(2)}</p>
                {/* </div> */}
              </div>
            </>
          )
